...
def sp500_time_machine(starting_balance: int, span_in_years: int, annual_contribution: int, current_year: int =None) -> None:
	realized_gain_list = []
	average_gain = 0
	current_year = current_year or datetime.date.today().year
	total_spans = (current_year - FIRST_YEAR - span_in_years) + 1
